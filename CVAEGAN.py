...
# only use is to import the classifier, generator of this model by other files.
    ...
    for epoch in range(num_epochs):
        ...
        if epoch % 100 == 0:
            if Constant.colab:
                ...
                torch.save(optimizer_ft.state_dict(),  '/content/gdrive/MyDrive/ic/trained_models/top_50/2_optC_model_classification_loss_epoch_{}.pt'.format(epoch))
                torch.save(optimizerD.state_dict(),  '/content/gdrive/MyDrive/ic/trained_models/top_50/2_opt_D_model_classification_loss_epoch_{}.pt'.format(epoch))
                torch.save(optimizerG.state_dict(),  '/content/gdrive/MyDrive/ic/trained_models/top_50/2_opt_G_model_classification_loss_epoch_{}.pt'.format(epoch))
            else:
